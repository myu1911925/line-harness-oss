  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[39px] left-6 z-50 flex items-center gap-2 px-4 py-3 min-h-[48px] bg-gray-900 text-white text-sm font-medium rounded-full shadow-lg hover:bg-gray-800 transition-colors"
        aria-label="CCに依頼"
      >
